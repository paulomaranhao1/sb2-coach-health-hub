...
const AdvancedFastingTimer = ({
  ...
  return (
    <Card className="border-2 border-gradient-to-r from-blue-500 to-purple-500 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950 dark:via-purple-950 dark:to-pink-950 shadow-2xl">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex justify-center gap-4">
          <Button
            ...
            variant="outline"
            size="lg"
            className="flex items-center gap-2 bg-white/80 hover:bg-white hover:scale-105 transition-all duration-200"
          >
