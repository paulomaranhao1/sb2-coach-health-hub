...
// Memoizar componente de status indicator
const StatusIndicator = memo(({ analysisStatus }: { analysisStatus: string }) => {
...
// Memoizar componente de upload buttons
const UploadButtons = memo(({ onCameraClick, onFileClick }: { 
  onCameraClick: () => void;
  onFileClick: () => void;
}) => (
...
UploadButtons.displayName = 'UploadButtons';

// Memoizar componente de preview da imagem
...
const PhotoAnalyzer = memo(({ onAnalysisComplete }: PhotoAnalyzerProps) => {
  ...
  }, [selectedImage, analysisStatus, onAnalysisComplete, toast]);

  const handleSave = useCallback(async (analysisData: FoodAnalysis) => {
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-slate-600">
            ...
            <div className="ml-auto">
              <StatusIndicator analysisStatus={analysisStatus} />
            </div>
          </CardTitle>
        </CardHeader>
