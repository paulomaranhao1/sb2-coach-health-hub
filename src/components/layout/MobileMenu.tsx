...
import { Home, MessageSquare, Camera, Clock, Trophy, Pill, ShoppingCart, LogOut, Sun, Moon, BookOpen, BarChart3, User, Settings, Mail, Target, Sparkles } from "lucide-react";
