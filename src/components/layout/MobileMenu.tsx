...
const MobileMenu = ({
  ...
  return <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 animate-fade-in" onClick={() => setShowMobileMenu(false)}>
      <div onClick={e => e.stopPropagation()} className="mobile-menu w-80 h-full shadow-2xl animate-slide-in-right transition-all duration-300 overflow-y-auto bg-slate-400">
        ...
        <div className="p-4 space-y-6 bg-slate-400">
          {/* Menu Principal */}
          <div>
