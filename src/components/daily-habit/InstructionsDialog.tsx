        ...
        <div className="space-y-3 sm:space-y-4 text-gray-700 dark:text-gray-300 max-h-[60vh] overflow-y-auto">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div>
                <p className="font-semibold text-xs sm:text-sm">1. Registre seu Peso</p>
            ...
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div>
                <p className="font-semibold text-xs sm:text-sm">2. Beba Água</p>
            ...
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div>
                <p className="font-semibold text-xs sm:text-sm">3. Tome seus Suplementos</p>
            ...
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div>
                <p className="font-semibold text-xs sm:text-sm">4. Mantenha-se Motivado</p>
            ...
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-yellow-200 dark:border-yellow-700 bg-yellow-50 dark:bg-yellow-900/20">
              ...
              <div>
                <p className="font-semibold text-xs sm:text-sm">5. Colete seus Pontos Diários</p>
