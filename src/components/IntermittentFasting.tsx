    ...
    onStop={stopFast} formatTime={formatTime} calculateProgress={calculateProgress} getFastingPhase={getFastingPhase} /> : <FastingPlanCard selectedPlan={selectedPlan} setSelectedPlan={setSelectedPlan} onStartFast={startFast} />}
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="flex flex-col h-auto w-full max-w-sm mx-auto bg-white/95 backdrop-blur-sm border-2 border-slate-200/50 rounded-2xl p-4 shadow-xl space-y-3">
          ...
          <TabsTrigger value="analytics" className="w-full flex items-center justify-center gap-3 rounded-xl px-8 py-6 font-bold text-lg transition-all duration-300 ease-out
          ...
          <TabsTrigger value="goals" className="w-full flex items-center justify-center gap-3 rounded-xl px-8 py-6 font-bold text-lg transition-all duration-300 ease-out
